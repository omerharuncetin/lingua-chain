...
contract VerbViper is ERC721, Ownable {
  ...
  constructor() ERC721('Verb Viper', 'Verb Viper') Ownable(msg.sender) {}

  function _baseURI() internal pure override returns (string memory) {
    return 'https://hackathon.omerharuncetin.com/api/nft/avatars/verb-viper/';
  }
